  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-[var(--omlu-text-primary)]">Session History</h1>
          <p className="mt-1 text-sm text-[var(--omlu-text-secondary)]">Historical table sessions and settlement status.</p>
        </div>
          ...
          <table className="w-full min-w-[1050px] text-sm">
            ...
            <tbody className="divide-y divide-zinc-800">
              {data.items.map((session) => (
                <tr key={session.id} className="bg-[var(--omlu-primary-surface)] hover:bg-[var(--omlu-muted-surface)]">
