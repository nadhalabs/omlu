...
export default function QuickSaleClient() {
  ...
  const printTakeaway = async (sale: QuickSale) => {
    if ((sale.sale_type !== "takeaway" && sale.sale_type !== "late_entry") || sale.status !== "completed" || printingToken) return;
